...
$mysqli = new mysqli('localhost','root','olamund0','test');
	...
	if(isset($_FILES['carta']) && $_FILES['carta'] != NULL){
		...
		$name0 = $hora . $uname;
		$mv0 = move_uploaded_file($_FILES['carta']['tmp_name'], '/Users/eva/Sites/Digital/BeTec/archivos/'.$name0.'');
	...
	if(isset($_FILES['banco']) && $_FILES['banco'] != NULL){
		...
		$name1 = $hora . $uname1;
		$mv1 = move_uploaded_file($_FILES['banco']['tmp_name'], '/Users/eva/Sites/Digital/BeTec/archivos/'.$name1.'');
