...
# Base de datos: btec
# Tiempo de Generaci�n: 2014-10-30 8:43:37 p.m. +0000
# ************************************************************
...
VALUES
	...
	(6,2,0,'Taller de Administración y Estrategia de Negocios (LAE)',40,30),
	(7,2,0,'Taller de Contaduría Pública y Finanzas (LCPF)',40,31),
	(8,2,0,'Taller de  Administración Financiera (LAF)',40,27),
	(9,2,0,'Taller de Mercadotecnia (LEM)',40,35),
	...
	(14,2,0,'Taller de Derecho (LED)',40,39),
	(15,2,0,'Taller de Derecho y Finanzas (LDF)',40,38),
	(16,2,0,'Taller de Letras Hispánicas (LLE)',40,40),
	(17,2,0,'Taller de Relaciones Internacionales (LRI)',40,38),
	(18,2,0,'Taller de Ciencias de la Comunicación y Medios Digitales (LCMD)',40,38),
